...
class SyncCall {
  ...
  void answerIfConditionPassed() {
    ...
    **/
    if (!userAnswered || callAnswered || !audioSessionActived || (stringeeCall == null && stringeeCall2 == null)) {
  ...
  Future<bool> reject() async {
    if (stringeeCall == null && stringeeCall2 == null) {
      print("SyncCall reject failed, call: " + stringeeCall.toString() + ", call2: " + stringeeCall2.toString());
      return false;
    }
  ...
  Future<bool> hangup() async {
    if (stringeeCall == null && stringeeCall2 == null) {
      print("SyncCall hangup failed, call: " + stringeeCall.toString() + ", call2: " + stringeeCall2.toString());
      return false;
    }
  ...
  void mute({bool isMute}) {
    if (stringeeCall == null && stringeeCall2 == null) {
      print("SyncCall mute failed, call: " + stringeeCall.toString() + ", call2: " + stringeeCall2.toString());
      return;
    }
  ...
  Future<bool> setSpeakerphoneOn() async {
    if (stringeeCall == null && stringeeCall2 == null) {
      print("SyncCall setSpeakerphoneOn failed, call: " + stringeeCall.toString() + ", call2: " + stringeeCall2.toString());
      return false;
    }
  ...
  void switchCamera() {
    if (stringeeCall == null && stringeeCall2 == null) {
      print("SyncCall switchCamera failed, call: " + stringeeCall.toString() + ", call2: " + stringeeCall2.toString());
      return;
    }
  ...
  Future<bool> enableVideo() async {
    if (stringeeCall == null && stringeeCall2 == null) {
      print("SyncCall enableVideo failed, call: " + stringeeCall.toString() + ", call2: " + stringeeCall2.toString());
      return false;
    }
